	...
	<xsl:template match="/layout">
		<html>
			<head>
				...
				<script type="text/javascript" src="{$_whomp_storage_url}/templates/xatulsa.com-frontpage/files/imageswap.js"></script>
			</head>
							...
							<div class="col">
								<div class="row-one">
									<a href="{$_whomp_base_url}/about" onmouseover="imgover('about');" onmouseout="imgout('about');">
										...
										<img class="img" id="img-about" src="{$_whomp_storage_url}/templates/xatulsa.com-frontpage/images/about-out.jpg" alt="About XA" />
									</a>
								</div>
								<div class="row-two">
									<a href="{$_whomp_base_url}/prayer" onmouseover="imgover('prayer');" onmouseout="imgout('prayer');">
										...
										<img class="img" id="img-prayer" src="{$_whomp_storage_url}/templates/xatulsa.com-frontpage/images/prayer-out.jpg" alt="Peak of the Week" />
									</a>
								</div>
							</div>
							<div class="col">
								<div class="row-one">
									<a href="{$_whomp_base_url}/service" onmouseover="imgover('service');" onmouseout="imgout('service');">
										...
										<img class="img" id="img-service" src="{$_whomp_storage_url}/templates/xatulsa.com-frontpage/images/service-out.jpg" alt="Rockin' Sockin' Tuesdays" />
									</a>
								</div>
								<div class="row-two">
									<a href="{$_whomp_base_url}/outreach" onmouseover="imgover('outreach');" onmouseout="imgout('outreach');">
										...
										<img class="img" id="img-outreach" src="{$_whomp_storage_url}/templates/xatulsa.com-frontpage/images/outreach-out.jpg" alt="Reaching Out" />
									</a>
								</div>
							</div>
							<div class="col">
								<div class="row-one">
									<a href="{$_whomp_base_url}/bible" onmouseover="imgover('bible');" onmouseout="imgout('bible');">
										...
										<img class="img" id="img-bible" src="{$_whomp_storage_url}/templates/xatulsa.com-frontpage/images/bible-out.jpg" alt="Get Yo' Word On" />
									</a>
								</div>
								<div class="row-two">
									<a href="{$_whomp_base_url}/more" onmouseover="imgover('more');" onmouseout="imgout('more');">
										<div class="txt-over" id="txt-more">More Info</div>
										<img class="img" id="img-more" src="{$_whomp_storage_url}/templates/xatulsa.com-frontpage/images/more-out.jpg" alt="More Info" />
									</a>
								</div>
							</div>
						</div>
